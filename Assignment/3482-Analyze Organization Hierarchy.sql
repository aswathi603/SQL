```
Question Link : https://leetcode.com/problems/analyze-organization-hierarchy/description/
...
hierarchy AS (
    -- Every employee as a root for subtree calculation
    SELECT
